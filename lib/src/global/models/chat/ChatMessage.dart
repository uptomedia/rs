import 'FromToUser.dart';
import 'ReplyMessage.dart';
...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) => ChatMessage(
        ...
        forwardFrom: json["forward_from"] == null
            ? ReplyMessage(createdAt: DateTime.now(), updatedAt: DateTime.now())
            : ReplyMessage.fromJson(json["forward_from"]),
        fromUser: FromToUser.fromJson(json["from_user"]),
        toUser: FromToUser.fromJson(json["to_user"]),
      );
